...
namespace rv
{
    class RVMonitor
    {
        public:
            ...
            void monitorCallback_turtleVelocity(const turtlesim::Velocity::ConstPtr& monitored_msg);
            void monitorCallback_turtlePose(const turtlesim::Pose::ConstPtr& monitored_msg);
